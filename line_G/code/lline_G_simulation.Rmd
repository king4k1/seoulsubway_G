...
for(i in 1:length(nms)){
  for(j in i:length(nms)){
    ...
    save(file="/home/students/kson/line_G/subway_route_G0529.RData",subway_route_G)
  }
}
...
#saveRDS(file="../data/shortestpath_G_0529.RDS", result_return)
#result_return <- readRDS(file="../data/shortestpath_G_0529.RDS")
...
saveRDS(file="../data/shortestpath_db_G.RDS", shortestpath_db_G)
```
